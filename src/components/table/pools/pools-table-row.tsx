  ...
  return (
    <tr className="pool-row cursor-pointer" onClick={onClick}>
      <td className="px-4 py-4">
        <div className="flex items-center gap-4">
          <div className="relative h-10 w-16">
            <div className="token-icon-wrapper absolute left-0 top-1/2 h-10 w-10 -translate-y-1/2 rounded-full border border-white/15 bg-[#0a0a0a] overflow-hidden">
              <Image
            ...
            <div className="token-icon-wrapper absolute right-0 top-1/2 h-10 w-10 -translate-y-1/2 rounded-full border border-white/15 bg-[#0a0a0a] overflow-hidden">
              <Image
            ...
            <HoverCard openDelay={200} closeDelay={100}>
              <HoverCardTrigger asChild>
                <button
                  ...
                  className="rounded p-1 text-white/30 transition-colors hover:bg-white/6 hover:text-white/60"
                >
      ...
      <td className="px-4 py-4 text-right">
        <span className="text-white font-bold">{apy.toFixed(2)}%</span>
      </td>
